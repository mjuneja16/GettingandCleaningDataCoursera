...
##extracting only the measurements on mean and standard deviation for each measurement to create a new data set 'mean_and_std'
...
##Using descriptive activity names to name the activities in the data set 'Y'
for(i in 1:nrow(Y))
{  
...
##labelling the 'X' data set with descriptive variable names to create a new data set 'X_lables' 
X_labels<-cbind(Y,X)
##labelling the 'mean_and_std' data set with descriptive variable names to create a new data set 'mean_and_std_labels'
...
##Creating a second, independent tidy data set 'averages' with the average of each variable for each activity and each subject 
